...
function NavBar() {
  ...
  return (
    <div className="sticky top-0 z-40 w-full">
      <div className="absolute z-30 flex w-full items-center justify-between overflow-x-hidden bg-white/10 px-4 py-3 text-2xl md:px-8 md:py-3 lg:px-12 lg:py-4">
